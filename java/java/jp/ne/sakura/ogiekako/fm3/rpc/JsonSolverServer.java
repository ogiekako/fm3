...
public class JsonSolverServer {

  private static final Logger logger = Logger.getLogger(JsonSolverServer.class.getName());

  public static void main(String[] args) {
    new JsonSolverServer().run();
  }
